...
class ProductService:
    ...
    @staticmethod
    def create_product(data: dict, stock: int) -> dict:
        """
    ...
    @staticmethod
    def get_catalog(page=1, per_page=9, search_query=None, category=None, spec_filters=None):
        """
        The Master Query.
    ...
    @staticmethod
    def get_admin_catalog(page=1, per_page=10, search_query=""):
        """
